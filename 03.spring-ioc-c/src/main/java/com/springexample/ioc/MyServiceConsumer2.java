...
public class MyServiceConsumer2 implements ServiceConsumer {
	...
	// new를 통해서 객체를 생성할 수 없도록 구현
	private MyServiceConsumer2() {}	
	// 객체를 1개만 유지하도록 구현
	private static MyServiceConsumer2 serviceConsumer;
	public static MyServiceConsumer2 newInstance() {
		System.out.println("newInstance is called");
		if (serviceConsumer == null) {
			serviceConsumer = new MyServiceConsumer2();
		}
